...
public class Person {
    ...
    public String toString() {
        return "Person{" + "id=" + id + ", firstName='" + firstName + '\'' + ", lastName='" + lastName + '\'' + ", age=" + age + ", createdAt=" + createdAt + ", insurance=" + insurance + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        return age == person.age && Objects.equals(id, person.id) && Objects.equals(firstName,
                ...
                person.lastName)
                && Objects.equals(createdAt, person.createdAt) && Objects.equals(insurance,
                person.insurance);
    }
